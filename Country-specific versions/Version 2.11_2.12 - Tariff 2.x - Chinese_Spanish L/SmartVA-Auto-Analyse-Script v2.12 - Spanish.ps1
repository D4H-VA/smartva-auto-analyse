                ...
                if($tariffpredictions -ne $null){
                    ...
                    ForEach ($prediction in $tariffpredictions){
                        ...
                        ForEach ($VA in $VAs){
                            ...
                            if($archiveResults -ne $null){
                                ...
                                if($x -eq 0){
                                    ...
                                    try{
                                        $sid + "," + $age + "," + $gender + "," + $cod1 + "," + $lh1 + "," + $cod2 + "," + $lh2 + "," + $cod3 + "," + $lh3 + "," + $as + "," + $PhdUCoD + "," + $datetime + "," | Add-Content -Encoding UTF8 $resultsfile -ErrorAction Stop
                        ...
                        if($archiveResultErrorCount -gt 0){
                            (new-object -ComObject wscript.shell).Popup("Could not write results to Archive file $resultsfile due to: `n`n$archiveErrorMsg`n`n Si este archivo está abierto, ciérrelo y repita el análisis para capturar los resultados en el archivoSi este archivo está abierto, ciérrelo y repita el análisis para capturar los resultados en el archivo",0,"Error")
                    ...
                    if($x -gt 0){
                        (new-object -ComObject wscript.shell).Popup("No hay resultados para mostrar. Todos los resultados ya están en el archivo de resultados del archivo.",0,"SmartVA Results")
                    }
                }else{
